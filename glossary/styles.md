...
* Mouthfeel: 
	...
	* alcohol warmth
* Bitterness: pronounced (25-50 IBUs)
* Flavors: 
...
* Other Names:
* Glassware: 
* Color: depends on base style (0-40 SRM)
* Alcohol: depends on base style (0-12% ABV)
* Mouthfeel: 
	* body: depends base style and grain used
	* carbonation: depends on base style
	* alcohol warmth: 
* Bitterness: depends on base style (0-100 IBUs)
* Flavors: 
...
* Notes:
	...
	* most Pre-Prohibition Porters are gone
		...
		* First one: Anchor Brewing in 1972
...
* Notes:
	...
	* protected category: can only be brewed in Berlin
...
* Mouthfeel: 
	...
	* alcohol warmth: slight 
* Bitterness: pronounced (20-45 IBUs)
* Flavors: 
...
* Bitterness: moderate (10-25 IBUs)
* Flavors: 
...
* Mouthfeel: 
	* body: medium-light - medium
	* carbonation: moderate - moderate-high
	* alcohol warmth: usually present, but low
* Bitterness: highly assertive (60-100 IBUs)
* Flavors: 
...
* Mouthfeel: 
	* body: medium - medium-full
	* carbonation: medium
	* alcohol warmth: minimal, if at all
* Bitterness: low (18-25 IBUs)
* Flavors: 
...
* Mouthfeel: 
	...
	* alcohol warmth
* Bitterness: moderate (18-30 IBUs)
* Flavors: 
...
* Notes:
	...
	* history 
		...
		* 1396, reps of brewers' guild founded Kölner Brauer-Kooperation (Cologne Brewers Association), which still exists
			* current day: 20 brewers, 11 of whom produce kölsch
		* 1800s, Bohemian lager imports led Cologne brewers to develop a pale beer of their own
			* this was the origin of the Kölsch
		* 1986 Cologne brewers renewed definitions: 
			* true kölsch: light-color, highly fermented, strongly hopped, bright, to-fermented Vollbier (beer with original gravity of 11-12%)
			* service: in 0.2 liter Stange
			* who is allowed to produce: Cologne brewers
...
* Mouthfeel: 
	...
	* alcohol warmth
* Bitterness: pronounced (25-35 IBUs)
* Flavors: 
...
* Notes:
	...
	* "running beers" - best drunk fresh
...
* Color: yellow - dark brown (4-22 SRM)
* Alcohol: elevated - high (7-11% ABV)
* Mouthfeel: 
	* body: thick, viscous, heavy with protein
	* carbonation: still - medium low
	* alcohol warmth: moderate, but masked by sweetness
* Bitterness: very low (0-15 IBUs)
* Flavors: 
...
* Mouthfeel: 
	...
	* carbonation: low - moderate
	* alcohol warmth
* Bitterness: moderate (15-35 IBUs)
* Flavors: 
...
* Mouthfeel: 
	...
	* carbonation: low - moderate
	* alcohol warmth
* Bitterness: moderate (10-20 IBUs)
* Flavors: 
	* malt: toasty bready malt, caramel, toffee, roast, subtle nuttiness
	* hop: light bitterness and hop flavor allowed
	* fermentation: clean, but light esters allowed
...
* Glassware: 
* Color: straw (2-3 SRM)
* Alcohol: normal - elevated (4.5-7% ABV)
* Mouthfeel: 
	* body: light
	* carbonation: moderate - high, effervescent
	* alcohol warmth: 
* Bitterness: very low (3-8 IBUs)
* Flavors: 
...
* Mouthfeel: 
	...
	* alcohol warmth: slight in stronger versions
* Bitterness: pronounced (30-50 IBUs)
* Flavors: 
...
* Notes:
	...
	* Production
		...
		* "Weihenstephan strain" of yeast is classic weissbier yeast
	...
	* variations:
		...
		* Leichtes weissbier: lower alcohol version
